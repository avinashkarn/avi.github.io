...
<ol>
 <li> 90% minimum sites persent
 <li> 5% minimum heterozygosity 
 <li> 100% maxmimum heterozygosity
</ol>
...
<ol>
 <li> 100 minimum count of 531 sequences (Its the number of times a particular allele was seen for that locus)
 <li> 0.05 Minor allele Frequency (set filter thresholds for rare alleles)
 <li> 0.95 Major allele frequency (set filter thresholds to remove monomorphic markers)
</ol>
