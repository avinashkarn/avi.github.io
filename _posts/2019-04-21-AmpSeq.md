...
The easy way to make a VCF file from your haplotype calls is to use this another script called *Haplotype_to_VCF.pl*, it can be downloaded at this <a href="https://github.com/avinashkarn/analyze_amplicon/blob/master/haplotype_to_VCF.pl">Link</a>
...
Fresnedo-Ramírez, Jonathan, Shanshan Yang, Qi Sun, <strong>Avinash Karn</strong>, Bruce I. Reisch, and Lance Cadle-Davidson.
*Frontiers in plant science* 10 (2019): 599.
